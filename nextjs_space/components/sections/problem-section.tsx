      ...
      <div className="container">
        ...
        >
          ...
          >
            <div className="mb-5 flex items-center gap-4">
              <motion.div 
                ...
                className="h-14 w-14 rounded-full bg-gradient-to-r from-red-500 to-pink-600 shadow-lg flex items-center justify-center text-qgd-fg font-bold text-xl"
              >
                J
              </motion.div>
              <div>
          ...
          >
            ...
            <div className="overflow-hidden rounded-3xl bg-qgd-card shadow-2xl dark:bg-qgd-card border border-[#2c2c3d]">
              <div className="bg-gradient-to-r from-red-600 via-red-500 to-pink-600 px-8 py-6 text-qgd-fg">
          ...
          <motion.div
            ...
            className="rounded-3xl bg-gradient-to-br from-gray-900 via-gray-800 to-black p-10 text-qgd-fg shadow-2xl border border-qgd-border"
          >
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              <motion.div 
                whileHover={{ y: -5 }}
                className="text-center p-6 rounded-xl bg-qgd-card/5 backdrop-blur-sm border border-white/10"
              >
