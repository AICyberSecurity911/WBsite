  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          style={{ y }}
          className="absolute top-20 left-10 w-96 h-96 bg-qgd-primary/400/10 rounded-full blur-3xl"
        />
        <motion.div 
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <div className="mb-16 text-center">
            ...
            >
              <Star className="h-5 w-5 fill-teal-500 text-qgd-ring500 animate-pulse" />
              <span className="bg-gradient-to-r from-teal-600 to-emerald-600 bg-clip-text text-transparent">
                Real Results from Real Businesses
              </span>
              <Sparkles className="h-4 w-4 text-qgd-ring500 group-hover:animate-spin" />
            </motion.div>
            ...
            >
              ...
              <span className="font-bold text-qgd-ring600 dark:text-qgd-ring400">87%</span>
              {' '}and reclaiming{' '}
          ...
          <div className="relative mx-auto mb-16 max-w-6xl perspective-1000">
              ...
              <div className="relative overflow-hidden">
                <AnimatePresence initial={false} custom={direction} mode="wait">
                  ...
                  >
                    ...
                    <motion.div 
                      className="absolute top-8 right-8 w-32 h-32 bg-qgd-primary/400/10 rounded-full blur-2xl pointer-events-none"
                      animate={{ 
                        scale: [1, 1.2, 1],
                        opacity: [0.3, 0.5, 0.3]
                      }}
                    ...
                    <div className="grid items-center gap-10 lg:grid-cols-2">
                      ...
                      <div className="relative z-10">
                        ...
                        >
                          <Quote className="mb-6 h-16 w-16 text-qgd-ring500 dark:text-qgd-ring400 opacity-80" />
                        </motion.div>
                        ...
                        >
                          <span className="text-qgd-ring600 dark:text-qgd-ring400">"</span>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="text-sm font-semibold text-qgd-ring600 dark:text-qgd-ring400">
                      ...
                      <div className="grid gap-5">
                        {currentTestimonial.metrics?.map((metric, idx) => (
                          ...
                          >
                            ...
                            >
                              <metric.icon className="h-8 w-8 text-qgd-fg" />
                            </motion.div>
                            ...
                            {/* Pulse Effect Icon */}
                            <motion.div
                              className="absolute top-3 right-3 text-qgd-ring500 opacity-0 group-hover:opacity-100"
            ...
            >
              ...
              >
                <ArrowLeft className="h-6 w-6 text-qgd-ring600 dark:text-qgd-ring400 group-hover:-translate-x-1 transition-transform" />
              </motion.button>
              ...
              <motion.button
                ...
                className="flex h-14 w-14 items-center justify-center rounded-full glass-premium shadow-xl hover:shadow-2xl hover:shadow-teal-500/30 transition-all group"
              >
                <ArrowRight className="h-6 w-6 text-qgd-ring600 dark:text-qgd-ring400 group-hover:translate-x-1 transition-transform" />
              </motion.button>
            </motion.div>
          </div>
