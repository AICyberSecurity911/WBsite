        ...
        >
          ...
          <div className="mb-8 grid gap-6 md:grid-cols-2">
            {[
              ...
              >
                <div className="mt-1 flex h-6 w-6 items-center justify-center rounded-full bg-qgd-primary/100 dark:bg-qgd-primary/900">
                  <item.icon className="h-4 w-4 text-qgd-ring600" />
                </div>
                <div>
