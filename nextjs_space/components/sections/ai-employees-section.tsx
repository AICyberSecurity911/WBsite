...
const aiEmployees: AIEmployee[] = [
  {
    ...
    badgeColor: 'bg-qgd-primary/100 dark:bg-qgd-primary/900/30 text-qgd-ring700 dark:text-qgd-ring300',
  ...
  },
  {
    ...
    title: 'AI Bookkeeper',
    badge: 'Fastest ROI',
    badgeColor: 'bg-qgd-primary/100 dark:bg-qgd-primary/900/30 text-qgd-primary700 dark:text-qgd-primary300',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.h2
            ...
            className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-qgd-fg mb-4"
          >
          ...
          {aiEmployees.map((employee, index) => (
            ...
            >
              ...
              <div className={`w-14 h-14 bg-gradient-to-br ${employee.color} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
                <employee.icon className="w-7 h-7 text-qgd-fg" />
              </div>

              {/* Title */}
              <h3 className="text-2xl font-bold text-slate-900 dark:text-qgd-fg mb-2">
                ...
                <ul className="space-y-2 text-sm">
                  {employee.realResults.map((result, i) => (
                    <li key={i} className="flex items-start space-x-2">
                      <Check className="w-4 h-4 text-qgd-ring600 flex-shrink-0 mt-0.5" />
              ...
              <details className="mb-4 group/details">
                <summary className="cursor-pointer text-sm font-semibold text-qgd-ring600 dark:text-qgd-ring400 hover:text-qgd-ring700 dark:hover:text-qgd-ring300 flex items-center gap-2">
              ...
              <div className="flex items-baseline space-x-2 mb-4">
                ...
                <span className="text-2xl font-bold text-slate-900 dark:text-qgd-fg">{employee.pricing.replace('$', '')}</span>
              ...
              <Link 
                href="#calculator" 
                className="block w-full text-center bg-qgd-primary/600 hover:bg-qgd-primary/700 text-qgd-fg py-3 rounded-xl font-semibold transition-all group-hover:shadow-lg"
              >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-qgd-primary/600 hover:bg-qgd-primary/700 text-qgd-fg">
