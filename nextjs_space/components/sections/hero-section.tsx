      ...
      <div className="container relative z-10 flex min-h-screen items-center pt-24 pb-20 lg:pt-28 lg:pb-16">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <motion.div
              ...
              className="mb-8 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-teal-50 to-emerald-50 px-5 py-2.5 text-sm font-semibold text-qgd-ring700 shadow-sm dark:from-teal-950/50 dark:to-emerald-950/50 dark:text-qgd-ring300 border border-teal-200 dark:border-teal-800"
            >
            ...
            >
              <p className="text-sm font-semibold text-[#b8b6c9] tracking-wide">
                ...
                <span className="mx-2 text-qgd-muted dark:text-qgd-muted">|</span>
            ...
            >
              ...
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-teal-500 to-emerald-500 shadow-md">
                  <Users className="h-5 w-5 text-qgd-fg" />
                </div>
            ...
            <div className="relative group">
              <div className="relative aspect-[4/3] overflow-hidden rounded-3xl bg-gradient-to-br from-teal-500 via-emerald-500 to-teal-600 p-8 shadow-2xl shadow-teal-600/30 hover:shadow-[0_0_60px_rgba(20,184,166,0.4)] transition-all duration-500">
                ...
                <motion.div 
                  ...
                  className="absolute -right-12 -top-12 h-48 w-48 rounded-full bg-qgd-card blur-2xl" 
                />
                <motion.div 
                  animate={{ 
                    scale: [1, 1.3, 1],
                ...
                />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-64 w-64 rounded-full bg-qgd-card/10 blur-3xl" />
                ...
                <div className="relative flex h-full items-center justify-center">
                  <div className="grid grid-cols-2 gap-4 w-full">
                    ...
                    <motion.div
                      ...
                      whileHover={{ scale: 1.05 }}
                      className="rounded-2xl bg-qgd-card/25 backdrop-blur-md p-6 text-qgd-fg shadow-lg hover:shadow-xl transition-all border border-white/30"
                    >
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-purple-500 to-pink-500 shadow-lg">
                    <CheckCircle className="h-5 w-5 text-qgd-fg" />
                  </div>
                  <div>
        ...
        >
          <div className="flex flex-col items-center space-y-3">
            <span className="text-sm font-medium text-qgd-muted dark:text-qgd-muted">Scroll to explore</span>
            <motion.div 
