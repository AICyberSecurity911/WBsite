        ...
        >
          ...
          <div className="mb-12 text-center">
            <motion.div
              ...
              className="mb-6 inline-flex items-center gap-2 rounded-full bg-qgd-primary/100 px-4 py-2 text-sm font-semibold text-qgd-ring900 dark:bg-qgd-primary/900 dark:text-qgd-ring300"
            >
          ...
          <div className="space-y-4">
            {faqData.map((item, index) => (
              <motion.div
                ...
                className="overflow-hidden rounded-2xl bg-qgd-card shadow-sm dark:bg-qgd-card"
              >
                <button
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <ChevronDown 
                      className={`h-5 w-5 text-qgd-muted transition-transform duration-200 ${
                ...
                >
                  <div className="border-t border-qgd-border px-6 py-5 dark:border-qgd-border">
                    ...
                    {item.category && (
                      <div className="mt-4">
                        <span className="rounded-full bg-qgd-primary/100 px-3 py-1 text-xs font-medium text-qgd-ring700 dark:bg-qgd-primary/900 dark:text-qgd-ring300">
                          {item.category}
                        </span>
                      </div>
                    )}
