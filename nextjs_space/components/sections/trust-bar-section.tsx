...
export function TrustBarSection() {
  ...
  return (
    <section ref={ref} className="border-t border-b border-qgd-border bg-qgd-card py-12 dark:border-qgd-border dark:bg-qgd-card/50">
      <div className="container">
        ...
        >
          <div className="mb-4 text-center">
            <p className="text-sm font-semibold text-qgd-muted dark:text-gray-200">
