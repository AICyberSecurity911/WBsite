      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <Card className="p-8">
          ...
          <div className="space-y-6">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-qgd-fg font-bold text-lg py-6 h-auto shadow-lg hover:shadow-xl transition-all duration-200"
            >
        ...
        <Card className={`p-8 relative ${!showResults && 'opacity-50'}`}>
          ...
          <div className="space-y-6">
            ...
            {/* Time Reclaimed */}
            <div className="p-4 rounded-xl bg-qgd-primary/50 dark:bg-qgd-primary/950/20 border-2 border-blue-200 dark:border-blue-800">
              <div className="flex items-center gap-2 mb-2">
            ...
            {/* Freedom Score */}
            <div className="p-4 rounded-xl bg-qgd-primary/50 dark:bg-qgd-primary/950/20 border-2 border-purple-200 dark:border-purple-800">
              <div className="flex items-center gap-2 mb-2">
          ...
          {showResults && (
            <div className="mt-6 space-y-4">
              <div className="p-4 rounded-xl bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-blue-950 dark:via-purple-950 dark:to-pink-950 border-2 border-purple-200 dark:border-purple-800">
                <h4 className="text-lg font-bold text-qgd-fg dark:text-qgd-fg mb-2">
                ...
                <div className="space-y-3">
                  ...
                  {(efficiency[0] < 4 || results.leakPercentage > 20 || parseInt(monthlyCost) > 100000) && (
                    <div className="rounded-lg border-2 border-qgd-border bg-qgd-card p-4 dark:border-qgd-border dark:bg-qgd-card">
                      <div className="flex items-start gap-3">
                        <div className="rounded-lg bg-gradient-to-br from-teal-500 to-emerald-500 p-2">
                          <Zap className="h-5 w-5 text-qgd-fg" />
                        </div>
                        <div className="flex-1">
                          <h5 className="font-bold text-qgd-fg dark:text-qgd-fg text-sm mb-1">
                            Intelligent Automation
                          </h5>
                          <p className="text-xs text-qgd-muted dark:text-gray-300 mb-2">
                            {efficiency[0] < 3 
                          ...
                          <a href="/intelligent-automation">
                            <Button size="sm" className="w-full sm:w-auto text-xs bg-qgd-primary/600 hover:bg-qgd-primary/700 text-qgd-fg">
                              Explore Automation →
                            </Button>
                          </a>
                        </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <a href="/background-checks">
                            <Button size="sm" className="w-full sm:w-auto text-xs bg-amber-600 hover:bg-amber-700 text-qgd-fg">
                              Verify Your Hires →
                            </Button>
                          </a>
                        </div>
          ...
          {/* Email Gate */}
          {showEmailGate && (
            <div className="mt-6 p-6 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 text-qgd-fg">
              ...
              <form onSubmit={handleEmailSubmit} className="space-y-3">
                <Input
                  ...
                  className="bg-qgd-card text-qgd-fg"
                  required
                />
                <Button
                  type="submit"
