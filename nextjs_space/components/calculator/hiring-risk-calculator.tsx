        ...
        <Card className="p-8">
          ...
          <div className="space-y-6">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white font-bold text-lg py-6 h-auto shadow-lg hover:shadow-xl transition-all duration-200"
            >
