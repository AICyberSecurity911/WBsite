  ...
  const renderSlider = (
    ...
    <div className="mb-6">
      <label className="block text-sm font-semibold mb-2 text-gray-900 dark:text-gray-100">
        {label}: <span className="text-teal-600 dark:text-teal-400">{(form as any)[key]} hrs/wk</span>
      </label>
      <input
        type="range"
        min={0}
      ...
      {result && (
        <div className="mt-8 border-t border-gray-200 dark:border-zinc-800 pt-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <div className="p-6 rounded-xl bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 text-center">
            ...
            <div className="p-6 rounded-xl bg-teal-50 dark:bg-teal-900/20 border-2 border-teal-500 text-center">
              <div className="text-sm text-teal-700 dark:text-teal-300 mb-2 font-medium">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-3">
                {result.recommendations.map((rec, i) => (
                  <div
                    key={i}
                    className="p-5 rounded-xl bg-gradient-to-r from-gray-50 to-teal-50 dark:from-zinc-800 dark:to-teal-900/10 border border-gray-200 dark:border-zinc-700 hover:shadow-md transition-shadow"
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="font-bold text-gray-900 dark:text-gray-100">
                        {rec.automation}
                      </div>
                      <div className="text-xs font-medium text-gray-600 dark:text-gray-400 bg-white dark:bg-zinc-900 px-3 py-1 rounded-full">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-gray-600 dark:text-gray-400">
                          <strong className="text-gray-900 dark:text-gray-100">{rec.estHoursSaved}</strong> hrs/wk saved
                        </span>
                      </div>
                      <div className="flex items-center gap-1">
          ...
          {!captured ? (
            <div className="bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-teal-900/20 dark:to-emerald-900/20 p-6 rounded-xl border-2 border-teal-200 dark:border-teal-800">
              <h5 className="font-bold text-lg mb-2 text-gray-900 dark:text-gray-100">
            ...
            <div className="text-center p-8 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-xl border-2 border-emerald-300 dark:border-emerald-700">
              ...
              <h5 className="font-bold text-xl mb-2 text-gray-900 dark:text-gray-100">
